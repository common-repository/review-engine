...
class ReviewEngine_Components_Modal_Insert {
	...
	private static function _add_actions() {
		if( is_admin() ) {
			add_action( 'wp_ajax_ree_modal_insert', array(__CLASS__, 'modal_content') );
		}
	}
	...
	public static function modal_content() {
		...
		wp_enqueue_script( 'reviewengine-insert', plugins_url('assets/insert.js', __FILE__), array( 'jquery' ), REE_VERSION );
...
ReviewEngine_Components_Modal_Insert::init();
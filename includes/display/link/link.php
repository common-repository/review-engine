...
class ReviewEngine_Components_Display_Link {
	...
	public static function enqueue_scripts() {
		wp_enqueue_script( 'display-link', plugins_url('assets/link.js', __FILE__), array('jquery', 'reviewengine-modal'), REE_VERSION );
	}

	public static function display_button( $buttons ) {
		$buttons .= sprintf( '<button type="button" class="btn btn-default btn-sm button-display-link">%s</button>', __('Link') );
...
ReviewEngine_Components_Display_Link::init();